...
% TODO : page de garde univ de toulouse
...
%% Jury
\njudge{10}
\makesomeone{judge}{1}{M. Jean-Luc {\sc Béchennec}}{École Centrale de Nantes}{Examinateur}
\makesomeone{judge}{2}{M. Emmanuel {\sc Grolleau}}{ISAE-ENSMA}{Rapporteur}
\makesomeone{judge}{3}{Mme. Claire {\sc Maiza}}{Grenoble INP}{Examinatrice}
\makesomeone{judge}{4}{M. Pascal {\sc Maurère}}{Airbus Operations SAS}{Encadrant industriel}
\makesomeone{judge}{5}{M. Éric {\sc Noulard}}{ONERA Toulouse}{Invité}
\makesomeone{judge}{6}{Mme. Claire {\sc Pagetti}}{ONERA Toulouse}{Directrice de thèse}
\makesomeone{judge}{7}{M. Laurent {\sc Pautet}}{Télécom ParisTech}{Rapporteur}
\makesomeone{judge}{8}{Mme. Isabelle {\sc Puaut}}{INRIA Rennes}{Examinatrice}
\makesomeone{judge}{9}{M. Pascal {\sc Sainrat}}{Université de Toulouse}{Encadrant}
